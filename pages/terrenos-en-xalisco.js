      ...
      >
        ...
        >
          ...
          <section style={{ paddingTop: "64px", paddingBottom: "24px" }}>
            ...
            >
              En PIV desarrollamos Vallegrand, un fraccionamiento de lotes
              urbanizados ubicado en Xalisco, Nayarit, diseñado para quienes
              buscan invertir en terrenos con alto potencial de valorización y
              certeza jurídica.
            </p>
          ...
          <section style={{ marginTop: "56px" }}>
            ...
            <div style={cardStyle}>
              ...
              <p style={{ fontSize: "17px", lineHeight: "1.8" }}>
                Nuestro objetivo es desarrollar proyectos sólidos que generen
                valor patrimonial y brinden certeza a nuestros clientes e
                inversionistas.
              </p>
          ...
          <section style={{ marginTop: "56px" }}>
            <div style={cardStyle}>
              ...
              <p style={{ fontSize: "17px", lineHeight: "1.8" }}>
                Vallegrand representa el primer desarrollo de PIV y refleja
                nuestro enfoque en planeación estratégica, calidad de ejecución y
                generación de valor inmobiliario.
              </p>
